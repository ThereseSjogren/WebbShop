...
{
    public partial class WomenJeans : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int number;
            string markupHTML = "";
            List<Product> allProductWomansJeansList = new List<Product>();
            WbsDAL wbs = new WbsDAL();
            wbs.OpenConnection(ConfigurationManager.ConnectionStrings["WebbShopConnectionString"].ConnectionString);
            allProductWomansJeansList = wbs.GetJeansWoman();
            foreach (Product p in allProductWomansJeansList)
            {
            ...
            InsertedProductsWJe.InnerHtml = markupHTML;
